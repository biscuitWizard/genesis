...
//!
//! The selection rules are ported from a MOO agent harness where they were
...
//!
//! Genesis differs from the original in one way worth stating. There, originals
...
use crate::genesis::harness::llm;
use crate::genesis::harness::sys;
use crate::genesis::harness::types::{Compaction, LogLevel, SeqSpan};
